package com.xclone.xclone.exception;
...
public class APIExceptionHandler {
    ...
    @ExceptionHandler(value = {com.xclone.xclone.exception.RequestException.class})
    public ResponseEntity<APIException> handleRequestException(com.xclone.xclone.exception.RequestException e) {
